    ...
    <div className="space-y-6">
      <Card className="card-glass">
        <CardHeader>
          ...
          <CardDescription>
            How MonadAI uses artificial intelligence to enhance your DeFi experience
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="prose prose-invert max-w-none pt-24 md:pt-4">
                ...
                <p>
                  MonadAI uses advanced artificial intelligence to transform how users interact with 
                  decentralized finance on the Monad Blockchain network. Our AI system combines multiple technologies 
                ...
                <p>
                  This multi-layered approach ensures that MonadAI provides accurate, helpful, and 
            ...
            <TabsContent value="models" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <p>
                  MonadAI leverages state-of-the-art AI models to power its intelligent features. 
                ...
                <div className="bg-cosmic-800 p-4 rounded-lg mt-4">
                  ...
                  <p className="mt-2">
                    ...
                    understanding and generation capabilities. This model enables MonadAI to:
                  </p>
                  <ul className="mt-2">
            ...
            <TabsContent value="data" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <p>
                  MonadAI's AI system integrates multiple data sources to provide comprehensive insights 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  <div className="bg-cosmic-800 p-4 rounded-lg">
                    ...
                    <p className="mt-2 text-xs text-muted-foreground">
                      Data is fetched in real-time from the Monad Blockchain for the most current insights.
                    </p>
                  </div>
...
Clearly indicate when advice is speculative vs data-driven.`}
            ...
            <TabsContent value="limitations" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-lg mt-4">
                  ...
                  <p className="mt-2">
                    MonadAI's AI features are designed to assist with portfolio management and market analysis, 
      ...
      <Card className="card-glass">
        <CardHeader>
          ...
          <CardDescription>
            How our AI system is integrated into the MonadAI platform
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="prose prose-invert max-w-none">
            <p>
              MonadAI's AI capabilities are implemented through a sophisticated architecture that 
            ...
            <ul>
              ...
              <li>Deeper integration with Monad Blockchain's unique features and capabilities</li>
