...
export function DesignaliCreative() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
              ...
              {sidebarItems.map((item) => (
                <div key={item.title} className="mb-1">
                  ...
                  {item.items && expandedItems[item.title] && (
                    <div className="mt-1 ml-6 space-y-1 border-l pl-3 animate-in slide-in-from-top-2 duration-300">
      ...
      {/* Main Content */}
      <div className={cn("min-h-screen transition-all duration-500 ease-out", sidebarOpen ? "md:pl-64" : "md:pl-0")}>
        <header className="sticky top-0 z-10 flex h-16 items-center gap-3 border-b bg-background/95 px-4 backdrop-blur">
          ...
          >
            <PanelLeft
              className={cn("h-5 w-5 transition-transform duration-300 ease-out", !sidebarOpen && "rotate-180")}
            />
          </Button>
                ...
                <TabsContent value="home" className="space-y-8 mt-0">
                  <section>
                    <motion.div
                      ...
                      className="overflow-hidden rounded-3xl bg-indigo-700 p-8 text-white"
                    >
                      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        <div className="space-y-4">
                          <Badge className="bg-white text-indigo-800 hover:bg-gray-100 rounded-xl font-medium border-0">
                            Premium
                          </Badge>
                          <h2 className="text-3xl font-bold text-white">Welcome to DesignAli Creative Suite</h2>
                          ...
                          <div className="flex flex-wrap gap-3">
                            <Button className="rounded-2xl bg-white text-indigo-700 hover:bg-gray-100 font-medium border-0">
                              Explore Plans
                            </Button>
                            <Button
                              variant="outline"
                              className="rounded-2xl bg-transparent border-2 border-white text-white hover:bg-white hover:text-indigo-700 font-medium"
                            >
                              Take a Tour
                            </Button>
                          </div>
